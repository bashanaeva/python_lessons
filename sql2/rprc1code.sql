-- Краткое описание --
-- Платежно-расчетный центр являющийся посредником для оплаты комунальных платежей. В структуре главный офис и множество касс для работы с абонентами.Принимается оплата по 3м услугам(газ,электроэнергия,тбо)у каждой услуги свой коэфициент по которому высчитывается сумма к оплате--
