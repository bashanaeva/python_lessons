...
CREATE TABLE `main_office` (
  ...
  KEY `fk_Main_Office_Employee1_idx` (`Employee_Employee_id`),
  CONSTRAINT `fk_Main_Office_Employee1` FOREIGN KEY (`Employee_Employee_id`) REFERENCES `employee` (`Employee_id`)
